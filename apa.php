 ...
 * Password: assassin (Base64: YXNzYXNzaW4=)
 */
...
$PASS_B64 = 'YXNzYXNzaW4='; // Base64 dari "assassin"
...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .login{background:#12121e;border:1px solid #ff4444;border-radius:16px;padding:40px;width:400px}
        .login h1{color:#ff4444;text-align:center;margin-bottom:20px;font-size:24px}
        ...
        .login button{width:100%;padding:12px;background:#ff4444;border:none;border-radius:8px;color:#fff;font-weight:bold;font-size:14px;cursor:pointer}
        .login button:hover{background:#cc3333}
        .login .error{color:#ff6666;text-align:center;margin-top:10px;font-size:13px}
...
<body>
    <div class="login">
        ...
        <?php endif; ?>
        <div class="hint">🔑 Password: assassin</div>
    </div>
</body>
</html>
    <?php
...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .sidebar .brand h1{color:#ff4444;font-size:18px}
        ...
        .sidebar .nav a:hover,.sidebar .nav a.active{color:#ff4444;background:rgba(255,68,68,0.05)}
        ...
        .header h2{font-size:16px;color:#ff4444}
        ...
        .flex input:focus{border-color:#ff4444}
        .flex button{padding:8px 16px;background:#ff4444;border:none;border-radius:6px;color:#fff;font-weight:bold;font-size:13px;cursor:pointer;font-family:'Courier New',monospace}
        .flex button:hover{background:#cc3333}
        ...
        .file-item .name.dir{color:#ff4444}
        ...
        .file-item .actions a:hover{color:#ff4444}
        ...
        .modal-box{background:#12121e;border:1px solid #ff4444;border-radius:12px;padding:24px;max-width:600px;width:90%;max-height:80vh;overflow:auto}
        .modal-box h3{color:#ff4444;margin-bottom:12px}
        ...
        .modal-box textarea:focus{border-color:#ff4444}
...
<div class="app">
    ...
    <div class="sidebar">
        ...
        <div class="nav">
            ...
            <a href="?auth=<?= $PASS ?>&logout=1" style="color:#ff4444;"><i class="fas fa-sign-out-alt"></i><span> Logout</span></a>
        </div>
    </div>
...
<div class="modal" id="editorModal">
    <div class="modal-box">
        ...
        <div class="actions">
            ...
            <button onclick="saveModalFile()" style="background:#ff4444;border:none;border-radius:6px;color:#fff;font-weight:bold;padding:8px 16px;cursor:pointer">Save</button>
        </div>
    </div>
</div>
